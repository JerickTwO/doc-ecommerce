/* empty css                                            */
import { a as createComponent, d as renderComponent, g as renderScript, e as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_BTInrGQy.mjs';
import 'kleur/colors';
...
import { $ as $$Image } from '../chunks/_astro_assets_DlDn8UoC.mjs';
/* empty css                                      */
...
const imageRequirements = new Proxy({"src":"/_astro/requirements.CaWAymSL.png","width":1012,"height":577,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Jerick/DEV/AstroJS/doc-ecommerce/src/assets/requirements.png";
							}
...
const twoImageRequirements = new Proxy({"src":"/_astro/requirementsTwo.DoiBOWSS.png","width":905,"height":469,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Jerick/DEV/AstroJS/doc-ecommerce/src/assets/requirementsTwo.png";
							}
...
Es decir debe tener los productos parametrizados con imágenes,
                  categorías o líneas, precios y ficha técnica para una correcta
...
</h4> ${renderComponent($$result2, "Image", $$Image, { "loading": "lazy", "src": imageRequirements, "class": "w-full max-w-[700px] border-2 border-yellow-600 rounded-xl hover:scale-105 transition-transform duration-500 cursor-pointer zoom-image", "alt": "imagen de ejemplo de requerimientos.", "data-zoom-src": imageRequirements.src, "data-astro-cid-keccc434": true })} </div> <div class="p-4" data-astro-cid-keccc434> <h4 class="font-semibold mb-2" data-astro-cid-keccc434>
Ejemplo de parametrización de ficha técnica:
</h4> ${renderComponent($$result2, "Image", $$Image, { "loading": "lazy", "src": twoImageRequirements, "class": "w-full max-w-[700px] border-2 border-yellow-600 rounded-xl hover:scale-105 transition-transform duration-500 cursor-pointer zoom-image", "alt": "segunda imagen de ejemplo de requerimientos.", "data-zoom-src": twoImageRequirements.src, "data-astro-cid-keccc434": true })} <img src="" alt="" data-astro-cid-keccc434> </div> </div> </div> </div> </div> <div class="grid grid-cols-2 gap-x-6 gap-y-6" data-astro-cid-keccc434> <div class="col-span-1 bg-white rounded-lg shadow-sm p-8" data-astro-cid-keccc434> <h3 class="text-xl font-semibold text-gray-900 mb-3" data-astro-cid-keccc434>Imagenes</h3> <p class="text-gray-700 mb-4" data-astro-cid-keccc434>
Los productos deben tener una configuración para las imágenes,
              puede ser fondo blanco<span class="font-bold" data-astro-cid-keccc434> o sin fondo </span>
, esto es discutido de acuerdo a la personalización de la página. Y
              la <span class="font-bold" data-astro-cid-keccc434> resolución mínima </span> permitida es
...
Los productos deben tener nombres cortos no tan extensos, <span class="font-bold" data-astro-cid-keccc434>
